...
_target setVariable ["HKX_varTerminal_commandLineStorage", _terminal select 5, true];
_target setVariable ["HKX_varTerminal_commandLineInput", _terminal select 6, true];
_target setVariable ["HKX_varTerminal_files", _terminal select 7, true];
